...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(12, 10, utf8_decode('ID'), 1, 0, 'C', 1);
      ...
      $this->Cell(40, 10, utf8_decode('ENTRADA'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('SALIDA'), 1, 1, 'C', 1);
   }
...
while ($datos= $sql_asistencia->fetch_object()) {
   $pdf->Cell(12, 10, utf8_decode("$datos->id_asistencia"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos->nombre $datos->apellido"), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode("$datos->dni"), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode("$datos->nom_cargo"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos->entrada"), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode("$datos->salida"), 1, 1, 'C', 0);
}
/* TABLA */
