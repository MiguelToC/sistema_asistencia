...
<div class="page-content">
    ...
    include "../controlador/controlador_change_password.php";
        ...
        <form action="" method="POST">
            ...
            while ($datos = $sql->fetch_object()) { ?>
                ...
                <div class="fl-flex-label mb-4 px-2 col-12">
                    <input type="password" placeholder="Clave Actual" class="input input__text" name="txtclaveactual">
                </div>

                <div class="fl-flex-label mb-4 px-2 col-12">
                    <input type="password" placeholder="Clave nueva" class="input input__text" name="txtclavenueva">
                </div>
                <div class="fl-flex-label mb-4 px-2 col-12 ">
