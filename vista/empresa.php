...
<div class="page-content">
    ...
    ?>
    <a href="registrar_usuario.php" class="btn btn-primary btn-rounded mb-3 float-right"><i class="fa-solid fa-plus"></i> Registrar</a>
        ...
        <tbody>
            ...
            while ($datos = $sql->fetch_object()) { ?>
                <tr>
                    ...
                    <td>
                        <a href="#" name="btneditar" data-toggle="modal" data-target="#exampleModal<?= $datos->id_usuario ?>" class="btn btn-warning"><i class="fa-solid fa-pen"></i></a>
                            ...
                            <div class="modal-body">
                                <form action="" method="post">
                                    ...
                                    <div class="text-right p-2">
                                        <a href="usuario.php" class="btn btn-secondary btn-rounded"><i class="fa-solid fa-arrow-left"></i> Regresar</a>
